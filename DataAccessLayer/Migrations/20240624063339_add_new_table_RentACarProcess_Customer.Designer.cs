...
namespace DataAccessLayer.Migrations
{
    ...
    [Migration("20240624063339_add_new_table_RentACarProcess_Customer")]
    partial class add_new_table_RentACarProcess_Customer
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EntitityLayer.Entities.About", b =>
                {
            ...
            modelBuilder.Entity("EntitityLayer.Entities.Car", b =>
                {
                    b.HasOne("EntitityLayer.Entities.Brand", "Brand")
                        .WithMany("Cars")
            ...
            modelBuilder.Entity("EntitityLayer.Entities.CarFeature", b =>
                {
                    ...
                    b.HasOne("EntitityLayer.Entities.Feature", "Feature")
                        .WithMany("CarFeatures")
            ...
            modelBuilder.Entity("EntitityLayer.Entities.CarPricing", b =>
                {
                    ...
                    b.HasOne("EntitityLayer.Entities.Pricing", "Pricing")
                        .WithMany("CarPricings")
            ...
            modelBuilder.Entity("EntitityLayer.Entities.RentACarProcess", b =>
                {
                    ...
                    b.HasOne("EntitityLayer.Entities.Customer", "Customer")
                        .WithMany("RentACarProcesses")
